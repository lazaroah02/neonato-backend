...
class CreatePacienteMutation(graphene.Mutation):
    ...
    def mutate(self, info, fecha, nombre_de_la_madre, direccion, municipio, provincia, diagnostico_egreso, alta, **kwargs):
        paciente = Paciente(
            ...
            riesgo = kwargs.get("riesgo", "null"),
            genetico = kwargs.get("genetico", "null"),
            precoz = kwargs.get("precoz", "null"),
            numero_control = kwargs.get("numero_control", 0),
            diag_prenatal = kwargs.get("diag_prenatal", "null"),
            hoja_conf = kwargs.get("hoja_conf", "null"),
            accion_inmediatas = kwargs.get("accion_inmediatas", "null"),
            cronograma_seg = kwargs.get("cronograma_seg", "null"),
            info_maternidad = kwargs.get("info_maternidad", "null"),
            coordinacion_equipo = kwargs.get("coordinacion_equipo", "null"),
            criterio_cirujano = kwargs.get("criterio_cirujano", "null"),
            presencia_en_salon = kwargs.get("presencia_en_salon", "null"),
            actuacion_afeccion = kwargs.get("actuacion_afeccion", "null"),
            ginecologo_asig =  kwargs.get("ginecologo_asig", "null"),
            coordinacion_traslado1 = kwargs.get("coordinacion_traslado1", "null"),
            coincidencia_diag = kwargs.get("coincidencia_diag", "null"),
            coordinacion_traslado2 = kwargs.get("coordinacion_traslado2", "null"),
            justific_traslado = kwargs.get("justific_traslado", "null"),
            evaluacion_trasl = kwargs.get("evaluacion_trasl", ""),
            deficiencias_trasl = kwargs.get("deficiencias_trasl", ""),
            interconsult_cirujano = kwargs.get("interconsult_cirujano", "null"),
            interconsult_medica = kwargs.get("interconsult_medica", "null"),
            estudios_inter_quirurgica = kwargs.get("estudios_inter_quirurgica", "null"),
            doc_contrarref = kwargs.get("doc_contrarref", "null"),
            programa_acciones = kwargs.get("programa_acciones", "null"),
            cronograma_atencion = kwargs.get("cronograma_atencion", "null"),
            confir_segunda_opinion = kwargs.get("confir_segunda_opinion", "null"),
            verificar_equipo_quirurgico = kwargs.get("verificar_equipo_quirurgico", "null"),
            verificar_equipo_anestesico = kwargs.get("verificar_equipo_anestesico", "null"),
